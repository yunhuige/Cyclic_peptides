...
def build_antechamber(InputFileName, ResidueName, CappingAtoms, CNTerm, Forcefield, NetCharge, HeadAtom='N', TailAtom='C'):
    ...
    if (1):  # we can skip this step if we just want to re-run  the charge modifications
        ...
        if (Forcefield=='Gaff') or (Forcefield=='G'):
...
"""
	...
	leapscript += 'source leaprc.ff99SB\n' 
	leapscript += '\n'
