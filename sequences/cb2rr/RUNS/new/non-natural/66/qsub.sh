...
gmx grompp -f mdp/equil_NVT.mdp -c solvent_ions_minimized.gro -p new.top -n index.ndx -o equil2.tpr -maxwarn -1
gmx mdrun -v -nt 1 -s equil2.tpr -c solvent_ions_equilibrated2.gro
